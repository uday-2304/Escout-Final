...
const ArenaHub = () => {
  ...
  const likeVideo = async (id, e) => {
    ...
    try {
      await fetch(`${API_BASE_URL}/api/arena/${id}/like`, {
        method: "PUT",
    ...
    <div className="arena-layout">
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .channel-name { color: var(--text-dim); text-decoration: none; }
                  ...
                  <div className="card-meta">
                    ...
                    {isPlayerVideo && (
                      <div className="actions-row">
                        ...
                        <button 
                          className="stat-item action-btn" 
                          onClick={(e) => {
                             e.stopPropagation();
                             navigate("/arena-chat", { state: { targetUserId: video.uploaderId } });
                          }}
                          style={{ marginLeft: "auto", color: "#00e5ff" }}
                        >
                          <FaEnvelope size={12}/>
                          <span>MESSAGE</span>
                        </button>
...
const ArenaVideoModal = ({ video, onClose, currentUserId, onUpdate }) => {
  ...
  const handlePostComment = async (e) => {
    ...
    try {
      await fetch(`${API_BASE_URL}/api/arena/${videoId}/comment`, {
        method: "POST",
        headers: {
